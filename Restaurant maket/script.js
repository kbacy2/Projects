...
var zoomButtons = document.querySelectorAll('.slider_our_stuff_zoom');
zoomButtons.forEach(function (zoomButton) {
    zoomButton.addEventListener('click', function (event) {
        var zoomButtonTarget = event.target.dataset.target;
        var showModalChief = document.querySelector('.' + zoomButtonTarget);
        var modalChiefImg = document.querySelector('.img_chief');
        document.body.addEventListener('wheel', preventScroll);
        showModalChief.style.display = 'block';
        modalChiefImg.src;
        ...
        closeModalChiefs.forEach(function (close) {
            close.addEventListener('click', function () {
                showModalChief.style.display = 'none';
...
var dishNavItems = document.querySelectorAll('.dish_nav_item');
dishNavItems.forEach(function (dishNavElem) {
    dishNavElem.addEventListener('click', function (event) {
        var mainMenuContents = document.querySelectorAll('.main_dish_menu');
        mainMenuContents.forEach(function (mainMenuContent) {
            mainMenuContent.style.display = 'none';
        });
        var dataTargetDishMenu = event.target.dataset.target;
        var showTargetDishMenu = document.querySelector('.' + dataTargetDishMenu);
        showTargetDishMenu.style.display = 'flex';
